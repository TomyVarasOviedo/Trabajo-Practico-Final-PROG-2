...
CREATE TABLE `clientes` (
  ...
  `fnacimiento` varchar(12) DEFAULT NULL,
  PRIMARY KEY (`dni`)
...
INSERT INTO `clientes` VALUES (2000,'carlos','mamani','calle falsa 123','06/04/2000'),(4567890,'marcelo','montinela','calle2255, hidalgo','05/07/2005');
